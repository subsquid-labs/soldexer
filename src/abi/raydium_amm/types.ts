import {Codec, struct, u64, address, fixedArray, ref, u128, u8} from '@subsquid/borsh'
...
export const WithdrawQueue: Codec<WithdrawQueue> = struct({
    ...
    head: u64,
    count: u64,
    buf: fixedArray(ref(() => WithdrawDestToken), 64),
})
...
export const TargetOrders: Codec<TargetOrders> = struct({
    owner: fixedArray(u64, 4),
    buyOrders: fixedArray(ref(() => TargetOrder), 50),
    ...
    calcPnlX: u128,
    calcPnlY: u128,
    sellOrders: fixedArray(ref(() => TargetOrder), 50),
